...
import { getCheckListCodeDefectMaster, getCheckListServiceVisitInspector } from '../../../../services/work_order_check_list';
import styles from './CheckListVisitInspectorCloseWorkCss';
type InterfaceProps = {
...
const CheckListVisitInspectorCloseWork = (props: { workOrderData: InterfaceProps }) => {
    ...
    const getCheckList = async () => {
        ...
        try {
            ...
            let response = await getCheckListServiceVisitInspector(props.workOrderData.orderId, props.workOrderData.workType);
            if (response) {
                let dataTitle = []
...
export default CheckListVisitInspectorCloseWork;