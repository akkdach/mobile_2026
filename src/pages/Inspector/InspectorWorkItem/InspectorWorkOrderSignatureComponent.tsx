...
const InspectorWorkOrderSignatureComponent = ({title, type, saveImageSign, visibleModal, setStateVisibleModal}: any) => {
...
export default InspectorWorkOrderSignatureComponent