...
const WorkOrderSignatureComponent = ({ title, type, saveImageSign, visibleModal, setStateVisibleModal }: any) => {
    ...
    const _onSaveEvent = async (result: any, type: string) => {
        ...
        // alert('Success', 'Signature Captured Successfully');
        // console.log('_onSaveEvent', result, type);
        const temp = {
            name: 'cacheimage.jpg',
            type: 'image/jpeg',
...
const styleLg = StyleSheet.create({
    ...
    modalWidth: { width: 800, height: 800, borderRadius: 15 }
})
const styleSm = StyleSheet.create({
    ...
    modalWidth: { width: 400, height: 800, borderRadius: 15 }
})

export default WorkOrderSignatureComponent